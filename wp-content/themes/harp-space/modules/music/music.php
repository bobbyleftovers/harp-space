			...
			if($tracks->have_posts())	{
				...
				while($tracks->have_posts()){
					...
					<div class="list__item">
						<span class="list__index"> TRACK <?= carbon_get_the_post_meta('track_number') < 10 ? '0'.carbon_get_the_post_meta('track_number') : carbon_get_the_post_meta('track_number') ?></span>
